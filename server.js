...
passport.use(new GithubStrategy({
    clientID: "552bda7ee2f67f710861",
    clientSecret: "1fa7d0421ef6db1753f294675bcfe914a73dcc43",
...
app.use(session({secret: "no secrets at all"}));
...
passport.deserializeUser(function(user, done) {
  ...
  // maybe you are geting to get the user from mongo by id?
  // null is for errors
  done(null, user);
});
